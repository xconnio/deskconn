...
func startLogsStream(t *testing.T) (client net.Conn, sendKey, receiveKey []byte) {
	...
	sendKey, receiveKey, err := deskconn.QuicClientKeyExchange(c)
...
func TestLogsInvalidSince(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Since: "notaduration", TailN: -1}), sendKey))
...
func TestLogsFileNotFound(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Source: "/nonexistent/path/file.log", TailN: -1}), sendKey))
...
func TestLogsFileEmpty(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Source: f.Name(), TailN: -1}), sendKey))
...
func TestLogsFileContent(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Source: f.Name(), TailN: 0}), sendKey))
...
func TestLogsFileTailN(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Source: f.Name(), TailN: 2}), sendKey))
...
func TestLogsFileFollow(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Source: path, Follow: true, TailN: -1}), sendKey))
...
func TestLogsFollowIgnoresPing(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgPing, nil, sendKey))
...
func TestLogsJournalNoEntries(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{TailN: 0}), sendKey))
...
func TestLogsJournalFakeService(t *testing.T) {
	...
	require.NoError(t, sendPortEnvelope(client, common.LogMsgControl,
		common.MustJSON(common.LogControlMsg{Source: "nonexistent-service-xyz123abc", TailN: 0}), sendKey))
